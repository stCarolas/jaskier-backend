...
public class EventController {
    ...
    public void callback(@RequestBody CallbackEvent event) {
        ...
        List<Song> songs = result.getResults()
            .map(song -> ImmutableSong.builder()
    ...
    public List<CallbackEvent> list(
        ...
        List<Event> events = List.ofAll(eventRepository.find(EventCriteria.event.channelId.is(channelId))
